...
| **Feature libraries** | Standalone libraries independent of Ignite: **Transactional Outbox** and **Migrations**. | [Framework libraries](./libraries/index.md) |
...
| Use a standalone feature library | [Transactional Outbox](./libraries/transactional-outbox.md), [Migrations](./libraries/migrations.md) |
