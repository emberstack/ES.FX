...
/// <summary>Helpers for the VIES HTTP client: bounded response-body capture and <c>Retry-After</c> parsing.</summary>
internal static class ViesHttp
{
    /// <summary>The maximum length captured from a response body for inclusion in a typed exception.</summary>
