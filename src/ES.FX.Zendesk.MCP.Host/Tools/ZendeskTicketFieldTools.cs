...
public sealed class ZendeskTicketFieldTools(IZendeskClient zendeskApiClient)
{
    ...
    [McpServerTool(Name = "ticket_fields_list", ReadOnly = true, OpenWorld = true)]
    [Description(
    ...
    [McpServerTool(Name = "ticket_fields_get", ReadOnly = true, OpenWorld = true)]
    ...
    [McpServerTool(Name = "ticket_fields_options_list", ReadOnly = true, OpenWorld = true)]
    [Description(
