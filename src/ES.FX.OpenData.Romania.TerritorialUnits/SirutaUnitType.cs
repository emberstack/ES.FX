...
/// <summary>
///     The SIRUTA unit type (<c>TIP</c>) of an administrative unit. Values are the raw SIRUTA codes. An unmapped
///     future code is preserved as its raw numeric value — an undefined enum member, detectable with
///     <c>Enum.IsDefined</c> — rather than remapped to <see cref="Unknown" /> or thrown.
/// </summary>
[PublicAPI]
public enum SirutaUnitType
{
    /// <summary>Unknown / unmapped SIRUTA type. A sentinel (value 0) that does not occur in shipped data.</summary>
    Unknown = 0,
