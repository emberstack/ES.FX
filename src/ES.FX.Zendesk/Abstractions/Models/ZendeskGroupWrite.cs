...
/// <summary>The <c>{ "group_membership": {...} }</c> envelope.</summary>
public sealed record ZendeskGroupMembershipResponse
{
    [JsonPropertyName("group_membership")] public ZendeskGroupMembership? GroupMembership { get; init; }
}