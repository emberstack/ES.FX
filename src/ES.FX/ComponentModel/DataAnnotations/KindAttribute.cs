...
/// <summary>
///     Attribute used to specify a custom type for an object
...
public class KindAttribute(string kind) : Attribute
{
    /// <summary>
    ///     Keeps a cache of the attributes for each type
    /// </summary>
    private static readonly ConcurrentDictionary<Type, KindAttribute?> TypeCache = new();
    ...
    public static string? For(Type type)
    {
        ...
        attribute = type.GetCustomAttribute<KindAttribute>();
