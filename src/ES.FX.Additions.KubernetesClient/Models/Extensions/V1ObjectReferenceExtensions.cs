...
{
    /// <summary>
    ///     Returns a <see cref="V1ObjectReference" /> from an <see cref="IKubernetesObject{TMetadata}" />.
    /// </summary>
    /// <param name="obj">The object used as the source for the reference.</param>
    ...
    public static V1ObjectReference ObjectReference(this V1ObjectMeta metadata)
    {
