...
public static class SerilogRequestLoggingHostingExtensions
{
    ...
    /// <param name="configureOptions"> An optional delegate that can be used for customizing the <see cref="RequestLoggingOptions"/>.</param>
    public static void UseSerilogRequestLogging(this IApplicationBuilder app, Action<RequestLoggingOptions>? configureOptions = null)
    {
