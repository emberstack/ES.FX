...
///     appears in <see cref="AnafBatchCompanyVatCheckResult.NotFound" /> (or a <c>null</c> from the singular lookup), not
///     here.
/// </summary>
[PublicAPI]
public sealed class AnafVatCheckException : Exception
{
    /// <summary>Creates a new <see cref="AnafVatCheckException" />.</summary>
    public AnafVatCheckException(HttpStatusCode? statusCode, string? responseBody, string message,
